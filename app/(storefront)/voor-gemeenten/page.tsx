        ...
        <Container className={styles.heroInner}>
          <div className={styles.heroCopy}>
            ...
            <p className={styles.heroSub}>
              Duurzame, biologisch afbreekbare gemeentevlaggen die minder
              microplastic achterlaten in de openbare ruimte. Vezels die tijdens
              gebruik loslaten breken af in plaats van te blijven liggen. In{" "}
              {HOOFDTEST.omgeving.toLowerCase()} brak {HOOFD_PCT}% van het doek
              af in {HOOFDTEST.duur} ({HOOFDTEST.norm}). Meetbaar voor
              MVI-rapportages en geschikt voor aanbestedingen.
            </p>
