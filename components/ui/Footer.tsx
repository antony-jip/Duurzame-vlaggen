...
const KNOWLEDGE_LINKS = [
  ...
  { href: "/afbreekbaarheid", label: "Zo is dat gemeten" },
      ...
      <div className={styles.footer}>
        <Container>
          ...
          <div className={styles.grid}>
            <div className={styles.brandCol}>
              ...
              <p className={styles.tagline}>
                ...
                wapperen. In zeewater brak 94,2% van het doek af in ruim drie en
                een half jaar, gemeten volgens ASTM D6691.
              </p>
          ...
          <div className={styles.bottom}>
            <span>
              &copy; {year} <span>Sign Company VOF</span> · Alle rechten
              voorbehouden.
            </span>
